...
background_03.py
si no es posible transformar el codigo en concurrente tenemos debemos
...
async def long_blocking_job(segundos):
    await asyncio.sleep(segundos)
...
async def main_task():
    ...
    while True:
        print("Transformamos a concurrente", str(block_time))
        await long_blocking_job(block_time)
